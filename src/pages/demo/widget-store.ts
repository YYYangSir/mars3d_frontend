...
const store: StoreOptions<WidgetState> = {
  state: {
    widgets: [
      ...
      {
        component: markRaw(defineAsyncComponent(() => import("@mars/widgets/demo/mars3d/index.vue"))),
        name: "mars3d"
      },
      {
        component: markRaw(defineAsyncComponent(() => import("@mars/widgets/demo/mars-new/front-main/index.vue"))),
        name: "mars-new"
      }
    ],
    openAtStart: ["mars-new"]
  }
}
